...
#ifndef PIKA_MODULE_STM32F1_DISABLE
...
class_def(STM32F1){
    __BEFORE_MOETHOD_DEF
    constructor_def(STM32F1_ADC, 193450093),
    constructor_def(STM32F1_IIC, 193458970),
    constructor_def(STM32F1_PWM, 193467065),
    constructor_def(STM32F1_lowLevel, 589823855),
    constructor_def(STM32F1_GPIO, 2089114740),
    constructor_def(STM32F1_UART, 2089601825),
    constructor_def(STM32F1_Time, 2089610356),
};
class_inhert(STM32F1, TinyObj);

PikaObj *New_STM32F1(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, STM32F1);
    return self;
}
#endif
...
method_typedef(
    STM32F1_ADC_platformRead,
    "platformRead", ""
);

class_def(STM32F1_ADC){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_ADC_platformEnable, 835227025),
    method_def(STM32F1_ADC_platformRead, 1797695974),
};
class_inhert(STM32F1_ADC, PikaStdDevice_ADC);

PikaObj *New_STM32F1_ADC(Args *args){
    PikaObj *self = New_PikaStdDevice_ADC(args);
    obj_setClass(self, STM32F1_ADC);
    return self;
}
...
method_typedef(
    STM32F1_GPIO_platformSetMode,
    "platformSetMode", ""
);

class_def(STM32F1_GPIO){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_GPIO_platformSetMode, 215449403),
    method_def(STM32F1_GPIO_platformDisable, 326843198),
    method_def(STM32F1_GPIO_platformEnable, 835227025),
    method_def(STM32F1_GPIO_platformLow, 1616275740),
    method_def(STM32F1_GPIO_platformHigh, 1797341162),
    method_def(STM32F1_GPIO_platformRead, 1797695974),
};
class_inhert(STM32F1_GPIO, PikaStdDevice_GPIO);

PikaObj *New_STM32F1_GPIO(Args *args){
    PikaObj *self = New_PikaStdDevice_GPIO(args);
    obj_setClass(self, STM32F1_GPIO);
    return self;
}
...
method_typedef(
    STM32F1_IIC_platformWrite,
    "platformWrite", ""
);

class_def(STM32F1_IIC){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_IIC_platformEnable, 835227025),
    method_def(STM32F1_IIC_platformWrite, 1348314773),
    method_def(STM32F1_IIC_platformRead, 1797695974),
};
class_inhert(STM32F1_IIC, PikaStdDevice_IIC);
...
method_typedef(
    STM32F1_PWM_platformSetFrequency,
    "platformSetFrequency", ""
);

class_def(STM32F1_PWM){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_PWM_platformSetDuty, 215133052),
    method_def(STM32F1_PWM_platformEnable, 835227025),
    method_def(STM32F1_PWM_platformSetFrequency, 2060729960),
};
class_inhert(STM32F1_PWM, PikaStdDevice_PWM);

PikaObj *New_STM32F1_PWM(Args *args){
    PikaObj *self = New_PikaStdDevice_PWM(args);
    obj_setClass(self, STM32F1_PWM);
    return self;
}
...
method_typedef(
    STM32F1_Time_sleep_s,
    "sleep_s", "s"
);

class_def(STM32F1_Time){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_Time_sleep_ms, 164842493),
    method_def(STM32F1_Time_sleep_s, 460522064),
};
class_inhert(STM32F1_Time, PikaStdDevice_Time);

PikaObj *New_STM32F1_Time(Args *args){
    PikaObj *self = New_PikaStdDevice_Time(args);
    obj_setClass(self, STM32F1_Time);
    return self;
}
...
method_typedef(
    STM32F1_UART_platformWrite,
    "platformWrite", ""
);

class_def(STM32F1_UART){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_UART_platformEnable, 835227025),
    method_def(STM32F1_UART_platformWrite, 1348314773),
    method_def(STM32F1_UART_platformRead, 1797695974),
};
class_inhert(STM32F1_UART, PikaStdDevice_UART);

PikaObj *New_STM32F1_UART(Args *args){
    PikaObj *self = New_PikaStdDevice_UART(args);
    obj_setClass(self, STM32F1_UART);
    return self;
}
...
method_typedef(
    STM32F1_lowLevel_readPin,
    "readPin", "pin"
);

class_def(STM32F1_lowLevel){
    __BEFORE_MOETHOD_DEF
    method_def(STM32F1_lowLevel_readPin, 1037775848),
};
class_inhert(STM32F1_lowLevel, TinyObj);

PikaObj *New_STM32F1_lowLevel(Args *args){
    PikaObj *self = New_TinyObj(args);
    obj_setClass(self, STM32F1_lowLevel);
    return self;
}
